...
class Sections
{
    public function get()
    {
        return collect([
            ...
            //Solicitudes
            new CsgtModule('Solicitudes', 'Solicitudes', 'solicitudes', 300, 'fas fa-paste', null, []),
            ...
            // Productos
            new CsgtModule('Productos', 'Productos', 'productos', 400, 'fas fa-pallet', null, []),
            ...
            // Inventarios
            new CsgtModule('Inventarios', 'Inventarios', 'inventarios', 500, 'fas fa-tasks', null, []),
            ...
            // Socios
            new CsgtModule('Socios', 'Socios', 'socios', 600, 'fas fa-handshake', null, []),
            new CsgtModule('Listado de Socios', 'Socios - Listado de Socios', 'socios.listado-socios', 10, 'fas fa-users', 'socios'),

            // Suministros
            new CsgtModule('Suministros', 'Suministros', 'suministros', 700, 'fas fa-shipping-fast', null, []),
