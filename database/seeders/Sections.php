...
class Sections
{
    public function get()
    {
        return collect([
            ...
            // Productos
            new CsgtModule('Productos', 'Productos', 'productos', 500, 'fas fa-pallet', null, []),
            ...
            // Inventarios
            new CsgtModule('Inventarios', 'Inventarios', 'inventarios', 600, 'fas fa-tasks', null, []),
            ...
            // Socios
            new CsgtModule('Socios', 'Socios', 'socios', 700, 'fas fa-handshake', null, []),
            new CsgtModule('Listado de Socios', 'Socios - Listado de Socios', 'socios.listado-socios', 10, 'fas fa-users', 'socios'),

            // Suministros
            new CsgtModule('Suministros', 'Suministros', 'suministros', 800, 'fas fa-shipping-fast', null, []),
