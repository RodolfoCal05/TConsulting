...
Route::group(['middleware' => ['auth', 'cancerbero']], function () {
    ...
    //Planillas
    Route::namespace('Planillas')->prefix('planillas')->name('planillas.')->group(function () {
        Route::resource('planilla', 'PlanillaController', ['only' => ['index', 'store', 'show', 'detail', 'update']]);
    });
